...
While this site is publicly accessible (no auth yet), all project data is placeholder only. Real client information, IPs, hardware serials, and documents will be added once auth is in place.

## Quick links

- [Project Template](/templates/project-template)
- [Demo Project SHC-DEMO-001](/projects/shc-demo-001)
